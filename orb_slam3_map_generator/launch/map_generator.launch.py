...
#---------------------------------------------
    ...
    #Essential_paths
    orb_map_generator_pkg = get_package_share_directory('orb_slam3_map_gen')
#---------------------------------------------
...
#---------------------------------------------
    ...
    depth_image_to_pcl_node = Node(
        package='orb_slam3_map_gen',
        executable='depth_image_to_pcl',
        output='screen',
        # prefix=["gdbserver localhost:3000"],
        parameters=["/home/carlos/ws_offboard_control/src/orb_slam3_map_generator/param/map_generator_params.yaml"])
