...
namespace ORB_SLAM3_Wrapper
{
        ...
        : SlamNodeBase("ORB_SLAM3_RGBD_ROS2", strVocFile, strSettingsFile, sensor)
    {
        ...
        this->declare_parameter("rgb_image_topic_name", rclcpp::ParameterValue("x500_depth_1/rgb/image_raw"));
        this->declare_parameter("depth_image_topic_name", rclcpp::ParameterValue("x500_depth_1/depth/image"));
